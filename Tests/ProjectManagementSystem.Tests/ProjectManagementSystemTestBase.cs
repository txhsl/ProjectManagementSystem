...
{
    public abstract class ProjectManagementSystemTestBase : AbpIntegratedTestBase<ProjectManagementSystemTestModule>
    {
        private DbConnection _hostDb;
        private Dictionary<int, DbConnection> _tenantDbs; //only used for db per tenant architecture

        protected ProjectManagementSystemTestBase()
        {
        ...
        protected void UsingDbContext(Action<ProjectManagementSystemDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<ProjectManagementSystemDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<ProjectManagementSystemDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<ProjectManagementSystemDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<ProjectManagementSystemDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<ProjectManagementSystemDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<ProjectManagementSystemDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<ProjectManagementSystemDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<ProjectManagementSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<ProjectManagementSystemDbContext, Task<T>> func)
        {
            T result;
