...
using ProjectManagementSystem.Configuration.Ui;
using ProjectManagementSystem.Sessions;
using ProjectManagementSystem.Web.Models;
using ProjectManagementSystem.Web.Models.Layout;

namespace ProjectManagementSystem.Web.Controllers
{
    public class LayoutController : ProjectManagementSystemControllerBase
    {
