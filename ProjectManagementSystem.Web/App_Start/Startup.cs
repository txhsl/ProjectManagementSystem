...
﻿using Abp.Owin;
using ProjectManagementSystem.Api.Controllers;
using ProjectManagementSystem.Web;
...
namespace ProjectManagementSystem.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in ProjectManagementSystemWebModule)
